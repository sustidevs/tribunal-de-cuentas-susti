<template>
    <v-bottom-navigation background-color="#393b44" color="#FACD89" fixed height="70">
      ...
      <div v-if=" (get_user.area === 'DPTO. NOTIFICACIONES')" class="Montserrat-SemiBold d-flex flex-row">
        <DropdownMenu titulo="BANDEJAS" icono="mdi-inbox-full" :listDesplegable="bandejas"/>
        <DropdownMenu titulo="EXPEDIENTES" icono="mdi-file-document-multiple-outline" :listDesplegable="expedienteNotificaciones"/>
      </div>
    </v-bottom-navigation>
</template>
...
export default {
  ...
  data: () => ({
    ...
    expedientes:[{titulo: 'Pase', icono:'mdi-file-send-outline', link:"/mis-expedientes"},{titulo: 'Recuperar', icono:'mdi-arrow-u-left-top', link:"/recuperar"},{titulo: 'Añadir Cédula', icono:'mdi-card-account-details-outline', link:"/cedula"}],
    ...
    expedientesMesaEntrada:[ {titulo: 'Nuevo', icono:'mdi-text-box-plus-outline', link:'/nuevo-expediente'},{titulo: 'Pase', icono:'mdi-file-send-outline', link:'/mis-expedientes'}, {titulo: 'Recuperar', icono:'mdi-arrow-u-left-top', link:'/recuperar'},  {titulo: 'Desglose', icono:'mdi-file-percent-outline', link:'/desglose'}, {titulo: 'Englose', icono:'mdi-text-box-plus-outline', link:'/englose'}],
    ...
    expedienteNotificaciones:[{titulo: 'Añadir cédula', icono:'mdi-card-account-details-outline', link:'/cedula'}, {titulo: 'Pase', icono:'mdi-file-send-outline', link:'/mis-expedientes'}, {titulo: 'Recuperar', icono:'mdi-arrow-u-left-top', link:'/recuperar'}]
