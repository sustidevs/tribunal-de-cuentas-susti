                ...
                <v-row class="tex" justify="start">
                    <v-col cols="12" sm="12" lg="6" class="px-5">
                        <div class="d-flex column d-flex-sm row">
                            <p class="pt-5 pr-3">E/REND.CTAS.SUBSIDIO.GTOS </p>
                            <v-text-field
                                :disabled="!isEditing"
  ...
  props: {
    ...
    methods: {
        cargaExtracto() {
            ...
            this.hasSaved = true
            const extracto = "E/REND.CTAS.SUBSIDIO.GTOS " + this.input1 + ". NORMA LEGAL: " + this.input2 + ". OTORGÓ: " + this.input3 + ". IMPORTE: $" + this. input4 + ". SUBSIDIOS" + ". INICIADOR: " + this.iniciador.nombre
