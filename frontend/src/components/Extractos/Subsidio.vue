  ...
  name: 'Subsidio',
    ...
    methods: {
        cargaExtracto() {
            ...
            this.hasSaved = true
            const extracto = "E/REND.CTAS.SUBSIDIO.GTOS " + this.input1 + ". NORMA LEGAL: " + this.input2 + ". OTORGÓ: " + this.input3 + ". IMPORTE: $" + this. input4 + ". SUBSIDIOS" + ". INICIADOR: " + this.nombreIniciador
