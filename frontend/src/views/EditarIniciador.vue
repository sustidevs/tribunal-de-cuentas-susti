            ...
            <v-row no-gutters justify="start" class="my-6">
                <v-col cols="12" sm="12" lg="6" class="pb-6">
                    ...
                    <v-row cols="6" no-gutters justify="start" class="pb-6">
                        ...
                        <v-col cols="12">
                            <text-field v-model="this.$store.getters.iniciador[0].email" icon="mdi-email"/>
                        </v-col>
                        <label-input texto="Teléfono"/>
                        <v-col cols="12">
                            <text-field v-model="this.$store.getters.iniciador[0].telefono" icon="mdi-phone"/>
                        </v-col>
                        <label-input texto="Dirección"/>
                        <v-col cols="12">
                            <text-field v-model="this.$store.getters.iniciador[0].direccion" icon="mdi-map-marker"/>
                        </v-col>
                        <v-col cols="12">
...
export default {
  ...
  components: {LabelInput, TextField},
    ...
    //     return {
    //         inic: {
    //         email: this.$store.getters.iniciador[0].email,
    //         telefono: this.$store.getters.iniciador[0].telefono,
    //         direccion: this.$store.getters.iniciador[0].direccion,
    //         },
    //     }
    // },
    ...
    methods: {
        ...mapActions([ 'iniciador', 'updateIniciador']),
    }
}
</script>
